...
export default function AcquisitionModal({ game, onClose, onSubmit }: { game: GameState; onClose: () => void; onSubmit: (p: { cardId: string; playerIndex: number }) => void }) {
  ...
  return (
    <div className="modal">
      <div className="modal-content">
        <h3>New Acquisition (end-of-game adjustment)</h3>
        <label>Card</label>
